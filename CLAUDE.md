...
- **デプロイのアセットが 15MB → 344MB・1,655 → 3,528ファイルになる**（1ページ約180KB）。無料枠の上限は**ファイル数 20,000・1ファイル 25MiB**。**2026-08-25 時点で 429MB・3,535ファイル**（1枚平均225KB。#195 の近傍10社と P2 で増えた）。ファイル数と1ファイルの大きさには余裕があり、Worker バンドルは gzip 1.70MB（無料枠の上限3MiB）
