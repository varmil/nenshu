 ...
 *
 * **平均年収カードの直後に置く**（C15・#821。P1 から C14 まではページの先頭だった）。
 * 5軸を1枚にまとめた図なので、カードの金額を5軸の1本として含み、下の節（働きやすさ・
 * 年齢別・推移）の要約にもなる。先頭を譲ったのは、検索から来る読者が探している答えが
 * 金額だから（`docs/company/spec.md` 1.21）。
 *
