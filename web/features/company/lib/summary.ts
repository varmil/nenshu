 ...
 *
 * **出し分けをここに閉じる。** 説明文を持たない会社があり（原文に事業の中身が無い
 * ENEOS のような会社。社数は `summaries.json` の側で決まる）、そこでは**節ごと出さない**——空の器・プレースホルダ・
...
export interface SummaryView {
  /** 1〜3文・全角15〜130字（C16 で改めた）。生成の規格は `pipeline/summary/prompts/generate.md`。 */
  text: string;
}
